...
function elevar(num, exponent) {
  ...
  // Tu código:
  var valorElevar = Math.pow(num, exponent);
  return valorElevar;
}
...
function redondearNumero(num) {
  ...
  // Tu código:
  var valorRedondeado = Math.round(num);
...
function redondearHaciaArriba(num) {
  ...
  // Tu código:
  var valorRedondeadoArriba = Math.ceil(num);
  return valorRedondeadoArriba;
}

function numeroRandom() {
  //Generar un número al azar entre 0 y 1 y devolverlo
  //Pista: investigá qué hace el método Math.random()
  var valorRandom = Math.random(0,1);
  return valorRandom;
}
